  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: "space-y-4",
        caption: "flex items-center justify-center relative h-10",
        caption_label: "mx-auto text-base font-semibold flex-1 text-center",
        nav: "absolute left-1 right-1 flex justify-between items-center",
        nav_button: cn(
